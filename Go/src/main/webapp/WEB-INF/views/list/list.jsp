...
<link rel="stylesheet" href="../../../resources/CSS/list.css?version=2.4" type="text/css">
...
<body>
   ...
   <div id="content">
      <div id="middle">
         ...
         <div class="write">
               <a href="../list/write"><input type="button" value="write" class="write" id="write"></a>
               </div>
            ...
            <c:if test="${paging.cri.pageNum == 1 and (keyword == null or keyword == '')}">
               ...
               <c:forEach items="${manager}" var="managerlist">
                  <tr id="notice">
                     ...
                     <td class="nick">${managerlist.id}</td>
