...
<div class ="left">
    <img src="../../../resources/image/eyewear2-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       ...
       <dt>상품간략 설명</dt>
           <dd> 	전체적으로 투명 프레임으로 제작된 안경입니다. 트렌디한 포인트를 주기 좋은 아이웨어입니다.</dd>
           <dd></dd>
           <dd></dd>
           <dd></dd>
           <dd></dd>
     ...
     <div class="number">
       ...
       <div>
    <img src="../../../resources/image/eyewear2-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/eyewear2-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/eyewear2-4.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
