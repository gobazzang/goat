...
<div class ="left">
    <img src="../../../resources/image/shoes-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
       <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="PADDING LEATHER FLIP FLOP"></dd>
       <dt>판매가</dt>
        <dd class="price" id="uniprice"><input type="text" id="uniprice1" style="border: none; background: transparent;" name="uniprice" readonly value="79000"></dd>
       <dt>상품간략 설명</dt>
           <dd>  - 유니크한 디자인의 플립플랍</dd>
           <dd>  - 고급스러운 소 가죽 소재</dd>
     ...
     <div class="number">
           ...
           <input type="hidden" name="price" id="price" value="79000">  
             </div>
       </div>
       ...
       <div>
    <img src="../../../resources/image/shoes-1-1.jpg" alt="" id="img1-1">
      </div>  
    ...
    *review
    ...
    <div id="review1">
     ...
     <input type="hidden" id="pname"  name="pname"  value="PADDING LEATHER FLIP FLOP">
    </div>
    </form>
    </div>
    </div>
