...
<div class ="left">
    <img src="../../../resources/image/bottom6-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
        <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="BLACK WRINKLE WASHING WIDE DENIM JEANS"></dd>
       <dt>판매가</dt>
        <dd class="price" id="uniprice"><input type="text" id="uniprice1" style="border: none; background: transparent;" name="uniprice" readonly value="56000"></dd>
       <dt>상품간략 설명</dt>
           <dd>  - 링클 워싱 가미</dd>
           <dd>  - 와이드한 실루엣</dd>
           <dd>  - 블랙 데님 컬러감</dd>
       ...
       <div class="number">
           ...
           <input type="hidden" name="price" id="price" value="56000">  
             </div>
       </div>
       ...
       <div>
    <img src="../../../resources/image/bottom6-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/bottom6-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom6-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom6-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom6-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom6-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom6-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom6-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom6-10.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review1">
     ...
     <input type="hidden" id="pname"  name="pname"  value="BLACK WRINKLE WASHING WIDE DENIM JEANS">
    </div>
    </form>
    </div>
    </div>
