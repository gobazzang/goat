...
<div class ="left">
    <img src="../../../resources/image/bottom8-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
        <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="TRACK WIDE DENIM JEANS"></dd>
       <dt>판매가</dt>
        <dd class="price" id="uniprice"><input type="text" id="uniprice1" style="border: none; background: transparent;" name="uniprice" readonly value="62000"></dd>
       <dt>상품간략 설명</dt>
           <dd>  - 트렌디한 사이드 라인 디테일</dd>
           <dd>  - 와이드한 실루엣</dd>
           <dd>  - 포인트 룩 연출</dd>
           <dd></dd>
           <dd></dd>
       ...
       <div class="number">
           ...
           <input type="hidden" name="price" id="price" value="62000">  
             </div>
       </div>
       ...
       <div>
    <img src="../../../resources/image/bottom8-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/bottom8-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom8-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom8-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom8-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom8-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom8-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom8-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom8-10.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
