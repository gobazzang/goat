...
<div class ="left">
    <img src="../../../resources/image/outwearlist7-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
       <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="MINIMAL BLAZER (2COLOR)"></dd>
       <dt>판매가</dt>
 ...
 <div>
    <img src="../../../resources/image/outwearlist7-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/outwearlist7-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist7-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist7-5.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist7-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist7-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist7-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist7-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist7-10.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review_btn">
     ...
     <input type="hidden" id="pname"  name="pname"  value="MINIMAL BLAZER (2COLOR)">
    </div>
    </form>
    </div>
    </div>
