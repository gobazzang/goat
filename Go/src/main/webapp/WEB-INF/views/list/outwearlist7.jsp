...
<div class ="left">
    <img src="../../../resources/image/outwearlist8-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
       <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="LACE POCKET SHIRT (3COLOR)"></dd>
       <dt>판매가</dt>
 ...
 <div>
    <img src="../../../resources/image/outwearlist8-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/outwearlist8-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist8-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist8-5.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist8-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist8-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist8-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist8-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist8-10.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review_btn">
     ...
     <input type="hidden" id="pname"  name="pname"  value="LACE POCKET SHIRT (3COLOR)">
    </div>
    </form>
    </div>
    </div>
