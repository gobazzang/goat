...
<div class ="left">
    <img src="../../../resources/image/bottom4-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
        <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="BACK SLIT BOOTS CUT DENIM JEANS (BLACK)"></dd>
       <dt>판매가</dt>
       ...
       <div>
    <img src="../../../resources/image/bottom4-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/bottom4-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom4-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom4-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom4-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom4-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom4-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom4-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom4-10.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review1">
     ...
     <input type="hidden" id="pname"  name="pname"  value="CBACK SLIT BOOTS CUT DENIM JEANS (BLACK)">
    </div>
    </form>
    </div>
    </div>
