...
<div class ="left">
    <img src="../../../resources/image/acc-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       ...
       <dl>
       <dt>상품명</dt>
        <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="SILM LEATHER LONG BELT (2COLOR)"></dd>
       <dt>판매가</dt>
     ...
     <div class="number">
       ...
       <div>
    <img src="../../../resources/image/acc-1-1.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/acc-1-2.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/acc-1-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/acc-1-4.jpg" alt="" id="img1-1">
       </div>
              <div>
    <img src="../../../resources/image/acc-1-5.jpg" alt="" id="img1-1">
       </div>
              <div>
    <img src="../../../resources/image/acc-1-6.jpg" alt="" id="img1-1">
       </div>
              <div>
    <img src="../../../resources/image/acc-1-7.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review1">
     ...
     <input type="hidden" id="pname"  name="pname"  value="CSILM LEATHER LONG BELT (2COLOR)">
    </div>
    </form>
    </div>
    </div>
