...
<div class ="left">
    <img src="../../../resources/image/bottom3-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
        <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="PIGMENT WIDE CARGO PANTS (3COLOR)"></dd>
       <dt>판매가</dt>
        <dd class="price" id="uniprice"><input type="text" id="uniprice1" style="border: none; background: transparent;" name="uniprice" readonly value="67000"></dd>
       <dt>상품간략 설명</dt>
           <dd>  - 포인트 컬러감</dd>
           <dd>  - 와이드한 실루엣</dd>
           <dd>  - 피그먼트 워싱 가미</dd>
       ...
       <div class="number">
           ...
           <input type="hidden" name="price" id="price" value="67000">  
             </div>
       </div>
       ...
       <div>
    <img src="../../../resources/image/bottom3-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/bottom3-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom3-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom3-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom3-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom3-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom3-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom3-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom3-10.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review1">
     ...
     <input type="hidden" id="pname"  name="pname"  value="PIGMENT WIDE CARGO PANTS (3COLOR)">
    </div>
    </form>
    </div>
    </div>
