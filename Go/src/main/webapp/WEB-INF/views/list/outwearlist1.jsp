...
<div class ="left">
    <img src="../../../resources/image/outwearlist1-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
       <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="CROP HOOD ZIP UP (4COLOR)"></dd>
       <dt>판매가</dt>
             ...
             <div class="COLOR">
               COLOR
             	  <select class="COLOR" name="category" id="coloroption">
             	        ...
             	        <option value="----">---------------</option>
						<option value="WHITE">MELANGE</option>
						<option value="SILVER">GREEN</option>
						<option value="SILVER">RED</option>
       ...
       <div>
    <img src="../../../resources/image/outwearlist1-2.jpg" alt="" id="img1-1">
      </div>  
      
       <div>
    <img src="../../../resources/image/outwearlist1-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-5.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-10.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/outwearlist1-11.jpg" alt="" id="img1-1">
      </div> 
      <div>
    <img src="../../../resources/image/outwearlist1-12.jpg" alt="" id="img1-1">
      </div>
      <div>
    <img src="../../../resources/image/outwearlist1-13.jpg" alt="" id="img1-1">
      </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review_btn">
     ...
     <input type="hidden" id="pname"  name="pname"  value="CROP HOOD ZIP UP (4COLOR)">
    </div>
    </form>
    </div>
    </div>
