...
<link rel="stylesheet"
	href="../../../resources/CSS/outwearlist.css?version=1.4" type="text/css">
...
<div class ="left">
    <img src="../../../resources/image/bottom2-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
        <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="BALLOON TUCK DENIM WIDE JEANS"></dd>
       <dt>판매가</dt>
       ...
       <div>
    <img src="../../../resources/image/bottom2-2.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/bottom2-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom2-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom2-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom2-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom2-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom2-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom2-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/bottom2-10.jpg" alt="" id="img1-1">
       </div>
    *review
    <div class ="review">
    <div class="review1">
    ...
    <div id="review1">
     ...
     <input type="hidden" id="pname"  name="pname"  value="BALLOON TUCK DENIM WIDE JEANS">
    </div>
    </form>
    </div>
    </div>
