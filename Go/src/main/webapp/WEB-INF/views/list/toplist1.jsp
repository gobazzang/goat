...
<div class ="left">
    <img src="../../../resources/image/toplist1-1.jpg" alt="" id="img1" name="filename">
</div>
<div class ="right">
    <div class="top">
       <dl>
       <dt>상품명</dt>
        <dd class="pname" id="pname"><input type="text" id="pname1" style="border: none; background: transparent;"  name="pname" readonly value="LOOSE CHECK SHIRT (2COLOR)"></dd>
       <dt>판매가</dt>
             ...
             <div class="COLOR">
               COLOR
             	  <select class="COLOR" name="category" id="coloroption">
             	        ...
             	        <option value="----">---------------</option>
						<option value="IVORY">BROWN GOLD</option>
						<option value="CAMEL">GRAY BLACK</option>
				  </select>
       ...
       <div>
    <img src="../../../resources/image/toplist1-1.jpg" alt="" id="img1-1">
      </div>  
       <div>
    <img src="../../../resources/image/toplist1-2.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-3.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-4.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-5.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-6.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-7.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-8.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-9.jpg" alt="" id="img1-1">
       </div>
       <div>
    <img src="../../../resources/image/toplist1-10.jpg" alt="" id="img1-1">
      </div> 
    *review
    <div class ="review">
    <div class="review1">
